...
function App(){
 ...
 <div className="game-menu"><span>{s.clan} / {difficultyLabel[s.difficulty]} · {s.lastMix}手でスタート</span><button onClick={()=>{setPlaying(false);window.scrollTo(0,0);}}>← 条件を選び直す</button></div>
